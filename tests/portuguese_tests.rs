...
use rust_fuzzy_clock::translator::{TimeTranslator, FuzzinessLevel, portuguese::PortugueseTranslator};
...
fn test_exact_12h_format() {
    ...
    assert_eq!(translator.translate(&time, FuzzinessLevel::Exact, false, false), "três quarenta e sete");
    
    let time = create_time_info(1, 5);
    assert_eq!(translator.translate(&time, FuzzinessLevel::Exact, false, false), "uma zero cinco");
}
...
fn test_exact_24h_format() {
    ...
    let time = create_time_info(15, 47);
    assert_eq!(translator.translate(&time, FuzzinessLevel::Exact, true, false), "quinze quarenta e sete");
    
    let time = create_time_info(1, 5);
    assert_eq!(translator.translate(&time, FuzzinessLevel::Exact, true, false), "uma zero cinco");
}
...
fn test_fuzzy_special_times() {
    ...
    assert_eq!(translator.translate(&time, FuzzinessLevel::Fuzzy, false, false), "três em ponto");
    
    // E quinze (quarter past)
    let time = create_time_info(9, 15);
    assert_eq!(translator.translate(&time, FuzzinessLevel::Fuzzy, false, false), "nove e quinze da manhã");
    
    // E meia (half past)
    let time = create_time_info(14, 30);
    assert_eq!(translator.translate(&time, FuzzinessLevel::Fuzzy, false, false), "duas e meia da tarde");
    
    // Para (to)
    let time = create_time_info(15, 45);
    assert_eq!(translator.translate(&time, FuzzinessLevel::Fuzzy, false, false), "quinze para quatro da tarde");
}
...
fn test_fuzzy_24h_format() {
    ...
    assert_eq!(translator.translate(&time, FuzzinessLevel::Fuzzy, true, false), "quinze e quinze");
    
    let time = create_time_info(23, 45);
    assert_eq!(translator.translate(&time, FuzzinessLevel::Fuzzy, true, false), "quinze para zero");
}
...
fn test_very_fuzzy() {
    ...
    assert_eq!(translator.translate(&time, FuzzinessLevel::VeryFuzzy, false, false), "três em ponto");
    
    let time = create_time_info(3, 20);
    assert_eq!(translator.translate(&time, FuzzinessLevel::VeryFuzzy, false, false), "cerca de três e quinze");
}
...
fn test_max_fuzzy() {
    ...
    assert_eq!(translator.translate(&time, FuzzinessLevel::MaxFuzzy, false, false), "manhã");
    ...
    assert_eq!(translator.translate(&time, FuzzinessLevel::MaxFuzzy, false, false), "noite");
    ...
    assert_eq!(translator.translate(&time, FuzzinessLevel::MaxFuzzy, false, false), "madrugada");
}
...
fn test_hour_one_gender() {
    ...
    assert_eq!(translator.translate(&time, FuzzinessLevel::Exact, false, false), "uma zero zero");
}
...
fn test_gender_aware_feminine_hours() {
    ...
    assert_eq!(translator.translate(&time, FuzzinessLevel::Exact, false, false), "uma trinta");
    
    let time = create_time_info(2, 0);
    assert_eq!(translator.translate(&time, FuzzinessLevel::Exact, false, false), "duas zero zero");
